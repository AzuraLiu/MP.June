...
PlotLevel<-aggregate(SapflowbySec$Sapflow, by = list(SapflowbySec$DOY, SapflowbySec$Block, SapflowbySec$ID,SapflowbySec$VPD),FUN = "sum")
names(PlotLevel)[1]<-"DOY"
names(PlotLevel)[2]<-"Block"
names(PlotLevel)[3]<-"ID"
names(PlotLevel)[4]<-"VPD"
names(PlotLevel)[5]<-"Sapflow"
