...
Sapflux<-read_excel("../Data/Processed/Daytime/Sapflux/sapflow/Sapflux.xlsx")
```
...
#write_xlsx(PlotLevel, "../Data/Processed/Daytime/Sapflux/sapflow/Sapflow.xlsx")
```
...
A
ggsave("../Data/Processed/Daytime/Sapflux/sapflow/plots/A.jpg", A, height = 7, width = 10, units = "in", dpi = 500)
...
B
ggsave("../Data/Processed/Daytime/Sapflux/sapflow/plots/B.jpg", B, height = 7, width = 10, units = "in", dpi = 500)
...
C
ggsave("../Data/Processed/Daytime/Sapflux/sapflow/plots/C.jpg", C, height = 7, width = 10, units = "in", dpi = 500)
...
O
ggsave("../Data/Processed/Daytime/Sapflux/sapflow/plots/O.jpg", O, height = 7, width = 10, units = "in", dpi = 500)
```
