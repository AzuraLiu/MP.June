...
PlotLevelSapwoodArea<-ggplot(PlotLevelSapwood, aes(DOY))+
  scale_x_continuous()+
  geom_point(aes(y=Sapwood, color=ID))+
  xlab("DOY")+ylab("Sapwood per Ground Area (cm^2/m^2)")+
...
ggsave("../Data/Processed/Sapwood/SapwoodPerGroundGS.jpeg", PlotLevelSapwoodArea, height = 7, width = 10, units = "in", dpi = 500)
```
