...
getwd()
Sap1<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap1.6.csv")
Sap2<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap2.6.csv")
Sap3<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap3.6.csv")
Sap4<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap4.6.csv")
...
write.csv(Sap1.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap1.Sum.6.csv")
write.csv(Sap2.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap2.Sum.6.csv")
write.csv(Sap3.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap3.Sum.6.csv")
write.csv(Sap4.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap4.Sum.6.csv")
```

```{r conversion}
getwd()
Sum1<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap1.Sum.6.csv")
Sum2<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap2.Sum.6.csv")
Sum3<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap3.Sum.6.csv")
Sum4<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap4.Sum.6.csv")
...
write.csv(Converted1, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S1.Sum.6.csv")
write.csv(Converted2, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S2.Sum.6.csv")
write.csv(Converted3, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S3.Sum.6.csv")
write.csv(Converted4, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S4.Sum.6.csv")
