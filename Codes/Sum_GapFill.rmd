...
getwd()
Sap1<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap1.8.csv")
Sap2<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap2.8.csv")
Sap3<-read.csv("../Data/Processed/Gap-Filled/Regressed/Sap3.8.csv")
...
write.csv(Sap1.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap1.Sum.8.csv")
write.csv(Sap2.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap2.Sum.8.csv")
write.csv(Sap3.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap3.Sum.8.csv")
write.csv(Sap4.Sum, row.names = FALSE, file ="../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap4.Sum.8.csv")
```

```{r conversion}
getwd()
Sum1<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap1.Sum.8.csv")
Sum2<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap2.Sum.8.csv")
Sum3<-read.csv("../Data/Processed/Gap-Filled/RegressedSums/Regressed/Sap3.Sum.8.csv")
...
write.csv(Converted1, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S1.Sum.8.csv")
write.csv(Converted2, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S2.Sum.8.csv")
write.csv(Converted3, row.names = FALSE, file ="../Data/Processed/Sums/Converted/S3.Sum.8.csv")
