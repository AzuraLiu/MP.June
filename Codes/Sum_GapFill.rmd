...
getwd()
Sap1<-read.csv("../Data/Processed/Daytime/Sapflux/raw/Sap1.9.csv")
Sap2<-read.csv("../Data/Processed/Daytime/Sapflux/raw/Sap2.9.csv")
Sap3<-read.csv("../Data/Processed/Daytime/Sapflux/raw/Sap3.9.csv")
Sap4<-read.csv("../Data/Processed/Daytime/Sapflux/raw/Sap4.9.csv")
...
```{r assign dn}
Sap1$PAR[Sap1$PAR>0]<- "Day"
Sap1$PAR <- gsub(0,"Night",Sap1$PAR)

Sap2$PAR[Sap2$PAR>0]<- "Day"
Sap2$PAR <- gsub(0,"Night",Sap2$PAR)

Sap3$PAR[Sap3$PAR>0]<- "Day"
Sap3$PAR <- gsub(0,"Night",Sap3$PAR)

Sap4$PAR[Sap4$PAR>0]<- "Day"
...
Sap3.dn<-aggregate(Sap3[,c(7:38)], by = list(Sap3$Date,Sap3$DOY, Sap3$PAR),FUN = "sum")
...
```
```{r}
#write.csv(Converted1, row.names = FALSE, file ="../Data/Processed/Daytime/Sapflux/converted/Sap1.5.csv")
#write.csv(Converted2, row.names = FALSE, file ="../Data/Processed/Daytime/Sapflux/converted/Sap2.5.csv")
write.csv(Converted3, row.names = FALSE, file ="../Data/Processed/Daytime/Sapflux/converted/Sap3.9.csv")
#write.csv(Converted4, row.names = FALSE, file ="../Data/Processed/Daytime/Sapflux/converted/Sap4.9.csv")
